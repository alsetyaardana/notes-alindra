...
Hal yang aku maksud **unlimited potensi** ini sebagai contoh: “Saya Ingin belajar bahasa mandarin, dengan IQ yang tidak terlalu tinggi namun dengan EQ yang baik dan memiliki Metacognitive yang baik” dengan kondisi tersebut berikut gambaranya:

- **IQ** : Membantu proses menghafal kalimat, kata atau karakter
- **EQ** : Membantu tetap tenang dalam proses pelafalan atau speaking
- **Metacognitive** : Membantu menganalisis prosesnya untuk membantu **fine tunning**.

**Referensi** : Gemini, John Flavell (1979), Dunning & Kruger (1999) etc.
